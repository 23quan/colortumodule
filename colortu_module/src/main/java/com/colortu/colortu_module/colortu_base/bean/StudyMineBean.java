 ...
 * @author : Code23
 * @time : 2021/4/19
 * @module : StudyMineBean
 * @describe :我的自习室列表bean
 */
public class StudyMineBean {
    ...
    public static class DataBean {
        private List<MyCreateBean> myCreate;
        private List<DeprecatedBean> deprecated;
        private List<MyInJoinBean> myInJoin;

        public List<MyCreateBean> getMyCreate() {
            return myCreate;
        }

        public void setMyCreate(List<MyCreateBean> myCreate) {
            this.myCreate = myCreate;
        }

        public List<DeprecatedBean> getDeprecated() {
            return deprecated;
        }

        public void setDeprecated(List<DeprecatedBean> deprecated) {
            this.deprecated = deprecated;
        }

        public List<MyInJoinBean> getMyInJoin() {
            return myInJoin;
        }

        public void setMyInJoin(List<MyInJoinBean> myInJoin) {
            this.myInJoin = myInJoin;
        }

        public static class MyCreateBean {
            private int id;
            private String uuid;
            private String name;
        ...
        public static class MyInJoinBean {
            private int id;
            private String uuid;
            private String name;
            private String password;
