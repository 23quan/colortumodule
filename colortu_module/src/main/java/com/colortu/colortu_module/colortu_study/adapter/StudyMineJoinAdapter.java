 ...
 * @author : Code23
 * @time : 2021/4/19
 * @module : StudyMineJoinAdapter
 * @describe :我加入的列表适配器
 */
public class StudyMineJoinAdapter extends BaseRecyclerAdapter<StudyMineBean.DataBean.MyInJoinBean> {
    //上下文
    private Context context;

    public StudyMineJoinAdapter(Context context) {
    ...
    @Override
    public void bindView(ViewDataBinding binding, final StudyMineBean.DataBean.MyInJoinBean item, int position) {
